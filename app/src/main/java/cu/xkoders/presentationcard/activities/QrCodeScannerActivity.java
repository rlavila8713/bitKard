...
public class QrCodeScannerActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
        ...
        switch (requestCode) {
            case REQUEST_CAMERA:
                if (grantResults.length > 0) {
                    ...
                    if (cameraAccepted) {
                        Log.v("cameraAccepted","camera id: "+camId);
                ...
                {
                    Log.v("grantResults",grantResults+"");
                }
                break;
        }
    }
    ...
    protected void onPause() {
        ...
        if(mScannerView!=null)
        {
           // mScannerView.resumeCameraPreview(this);
            Log.v("mScannerView",mScannerView+"");
        }
    }
    ...
    public void onResume() {
        ...
        int currentapiVersion = android.os.Build.VERSION.SDK_INT;
        int version_M = android.os.Build.VERSION_CODES.M;
        ...
        if (currentapiVersion >= android.os.Build.VERSION_CODES.M) {
            ...
            Log.v("entra","currentapiVersion>=M");
        } else {
            requestPermission();
            Log.v("requestPermission","requestPermission");
        }
    }
